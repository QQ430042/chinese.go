 ...
 * 作者姓名           修改时间           版本号              描述
 */
package org.chinese.go.notebook.view;
 ...
 */
@FXMLView(value = "/org/chinese/go/notebook/notebook.fxml",title = "程序主框架面板")
public class NotebookView extends AbstractFxmlView {
}