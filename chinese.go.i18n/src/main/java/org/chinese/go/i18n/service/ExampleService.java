...
//import org.chinaese.go.base.entity.StClassify;
//import org.chinaese.go.base.entity.StCode;
//import org.chinaese.go.base.repository.StClassifyRepository;
//import org.chinaese.go.base.repository.StCodeRepository;
...
// * @createDate 2019年2月8日
// * @version 2.2.1.RELEASE
// * @Project cgo.base.service
// *
// * @copyright www.chinaesego.org
// */
//@RestController
//@RequestMapping("/api/base/example")
//@Location(code = "StUserApi", desc = "用户信息服务")
//public class ExampleService {
//
//	@Autowired
//	private StCodeRepository codeRepository;
//
//	@Autowired
//	private StClassifyRepository classifyRepository;
//
//	public StClassify createStClassify(StClassify classify) {
//
//		classifyRepository.save(classify);
//		return classify;
//	}
//
//	public StClassify findById(String classifyCode) {
//
//		StClassify classify = classifyRepository.getOne(classifyCode);
//		return classify;
//	}
//
//	public StCode createStClassify(StCode classify) {
//
//		codeRepository.save(classify);
//		return classify;
//	}
//
//	public StCode findStCodeById(String classifyCode) {
//
//		StCode classify = codeRepository.getOne(classifyCode);
//		return classify;
//	}
//	
//	@GetMapping("/list1")
//	@Operation(code = "list1", desc = "获取信息")
//	public Page<StClassify> list1() {
//		Pageable pageable = new QPageRequest(0,50);
//		return classifyRepository.findAll(pageable);
//	}
//	
//	@GetMapping("/list2")
//	@Operation(code = "list2", desc = "获取信息")
//	public Page<StCode> list2() {
//		Pageable pageable = new QPageRequest(0,50);
//		return codeRepository.findAll(pageable);
//	}
//	
//	@GetMapping("/save")
//	@Operation(code = "save", desc = "获取信息")
//	public StClassify save() {
//		StClassify classify = new StClassify();
//		classify.setClassifyDesc("测试--1");
//		classify.setClassifyId("test");
//		classify.setClassifyName("测试--1");
//		classify.setClassifyType("list");
//		classify.setCreatedUserId("U00001");
//		classify.setLastModifiedUserId("U00001");
////		classify.setShowOrder(0);
//		classify.setDeleteFlag("N");
//		classifyRepository.save(classify);
//		 return classify;
//	}
//
